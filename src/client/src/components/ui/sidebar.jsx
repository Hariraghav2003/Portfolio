...
// Additional subcomponents like SidebarTrigger, SidebarContent, SidebarMenuButton, etc.
// All forward refs remain, TypeScript types removed for JSX
// They are unchanged except without type annotations

export {
  Sidebar,
  SidebarProvider,
  useSidebar,
  // All other subcomponents (SidebarContent, SidebarTrigger, SidebarMenu, SidebarMenuButton, etc.)
};
